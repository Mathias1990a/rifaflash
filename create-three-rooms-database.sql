-- CREAR BASE DE DATOS CON 3 SALAS CORRECTAS
SELECT 'CREAR BASE DE DATOS CON 3 SALAS CORRECTAS' as section;
SELECT 'Sala Standard: $3.000 con 50 números' as room1;
SELECT 'Sala Premium: $5.000 con 25 números' as room2;
SELECT 'Sala VIP: $10.000 con 15 números' as room3;
...
-- 3. Crear las 3 salas con precios y cantidades correctas
SELECT '=== CREANDO 3 SALAS ===' as section;

-- Sala Standard: $3.000 con 50 números (premio $150.000)
...
-- Sala Premium: $5.000 con 25 números (premio $125.000)
INSERT INTO rooms (id, name, price, max_numbers, prize, created_at)
SELECT 
    uuid_generate_v4(),
    'Sala Premium',
...
-- Sala VIP: $10.000 con 15 números (premio $150.000)
INSERT INTO rooms (id, name, price, max_numbers, prize, created_at)
SELECT 
    uuid_generate_v4(),
    'Sala VIP',
...
SELECT '=== CREANDO NÚMEROS PARA CADA SALA ===' as section;
...
SELECT '=== VERIFICACIÓN DE SALAS CREADAS ===' as section;
...
SELECT '=== BASE DE DATOS CON 3 SALAS CREADA ===' as final_status;
SELECT 'Sala Standard: $3.000 con 50 números' as msg1;
SELECT 'Sala Premium: $5.000 con 25 números' as msg2;
SELECT 'Sala VIP: $10.000 con 15 números' as msg3;
